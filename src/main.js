...
const extraKeys = { e: 12, r: 13, t: 14, y: 15, u: 16, i: 17, o: 18 };
...
function frame() {
  ...
  camera.lookAt(0, 0, 0);
  hud.textContent = [
    `GAIA VISUALIZER  band-137  stage-6  nodes=${count}${useInstancing ? ' instanced' : ''}`,
    `geometry: ${targetState.geometry}   (1-9 / 0 / q / w / e r t y=enneper u=gyroid i=calabi o=figure8)`,
