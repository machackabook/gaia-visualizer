/**
 * Living chat-kernel contract — Stage 152.
 ...
 * Stage 152: session paste reconfirmed 2026-09-16 23:19 CDT. matchSessionPaste scans case labels.
 * Klein / hopf / figure8 / trefoil still not in the session switch.
 */

export const STAGE = 152;
...
export function confirmSessionKernel() {
  return {
    ...
    note: 'Session paste 2026-09-16 23:19 CDT matches beec41f1. Klein/hopf/figure8/trefoil stay runtime-only. Stage 152 CPU evaluate zeros non-finite coords; GPU ids 12/13/8/7 unchanged.',
  };
}
