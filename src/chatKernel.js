/**
 * Living chat-kernel contract — Stage 160.
 ...
 * Stage 160: session paste reconfirmed 2026-09-17 16:08 CDT. matchSessionPaste scans case labels.
 * Klein / hopf / figure8 / trefoil still not in the session switch.
 * Stage 160 also lowers the InstancedMesh GPU/TF auto path to count > 1024.
 */
...
export function confirmSessionKernel() {
  return {
    ...
    note: 'Session paste 2026-09-17 16:08 CDT matches beec41f1. Klein/hopf/figure8/trefoil stay runtime-only. Stage 160 GPU/TF auto-enable at count>1024; CPU evaluate zeros non-finite coords; GPU ids 12/13/8/7 unchanged.',
  };
}
