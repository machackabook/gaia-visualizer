/**
 * Living chat-kernel contract — Stage 107.
 ...
 * Stage 107: session paste reconfirmed 2026-09-14 09:08 CDT. matchSessionPaste scans case labels.
 * Klein / hopf / figure8 / trefoil still not in the session switch.
 */

export const STAGE = 107;
...
export function confirmSessionKernel() {
  return {
    ...
    note: 'Session paste 2026-09-14 09:08 CDT matches beec41f1. Klein/hopf/figure8/trefoil stay runtime-only. Stage 107 CPU evaluate matches GPU ids 12/13/8/7.',
  };
}
