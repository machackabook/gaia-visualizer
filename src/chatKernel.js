/**
 * Living chat-kernel contract — Stage 129.
 ...
 * Stage 129: session paste reconfirmed 2026-09-15 13:12 CDT. matchSessionPaste scans case labels.
 * Klein / hopf / figure8 / trefoil still not in the session switch.
 */

export const STAGE = 129;
...
export function confirmSessionKernel() {
  return {
    ...
    note: 'Session paste 2026-09-15 13:12 CDT matches beec41f1. Klein/hopf/figure8/trefoil stay runtime-only. Stage 129 CPU evaluate matches GPU ids 12/13/8/7.',
  };
}
