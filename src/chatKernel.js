/**
 * Living chat-kernel contract — Stage 91.
 ...
 * Stage 91: session paste reconfirmed 2026-09-12 23:02 CDT. matchSessionPaste scans case labels.
 * Klein / hopf / figure8 / trefoil still not in the session switch.
 */

export const STAGE = 91;
...
export function confirmSessionKernel() {
  return {
    ...
    note: 'Session paste 2026-09-12 23:02 CDT matches beec41f1. Klein/hopf/figure8/trefoil stay runtime-only. Stage 91 CPU evaluate matches GPU ids 12/13/8/7.',
  };
}
