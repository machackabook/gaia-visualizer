/**
 * Living chat-kernel contract — Stage 98.
 ...
 * Stage 98: session paste reconfirmed 2026-09-13 15:14 CDT. matchSessionPaste scans case labels.
 * Klein / hopf / figure8 / trefoil still not in the session switch.
 */

export const STAGE = 98;
...
export function confirmSessionKernel() {
  return {
    ...
    note: 'Session paste 2026-09-13 15:14 CDT matches beec41f1. Klein/hopf/figure8/trefoil stay runtime-only. Stage 98 CPU evaluate matches GPU ids 12/13/8/7.',
  };
}
