/**
 * Living chat-kernel contract — Stage 284.
 ...
 * Stage 284: session paste reconfirmed 2026-09-25 10:00 CDT. matchSessionPaste scans case labels.
...
export function confirmSessionKernel() {
  return {
    ...
    nodeCap: NODE_CAP,
    note: 'Session paste 2026-09-25 10:00 CDT matches beec41f1. Klein/hopf/figure8/trefoil stay runtime-only. Stage 284 Hive waterfall; GPU/TF auto-enable at count>1024; skip CPU instance matrices at 4096-16384; chatKernelLerpAlpha shared; CPU evaluate zeros non-finite coords; GPU ids 12/13/8/7 unchanged.',
  };
}
