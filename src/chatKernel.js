...
export function confirmSessionKernel() {
  return {
    ...
    note: 'Session paste 2026-09-20 15:01 CDT matches beec41f1. Klein/hopf/figure8/trefoil stay runtime-only. Stage 217 GPU/TF auto-enable at count>1024; CPU evaluate zeros non-finite coords; GPU ids 12/13/8/7 unchanged.',
  };
}
