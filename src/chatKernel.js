/**
 * Living chat-kernel contract — Stage 83.
 ...
 * Stage 83: session paste reconfirmed 2026-09-12 17:03 CDT. matchSessionPaste scans case labels.
 * Klein / hopf / figure8 / trefoil still not in the session switch.
 */

export const STAGE = 83;
...
export function confirmSessionKernel() {
  return {
    ...
    note: 'Session paste 2026-09-12 17:03 CDT matches beec41f1. Klein/hopf/figure8/trefoil stay runtime-only. Stage 83 CPU evaluate matches GPU ids 12/13/8/7.',
  };
}
