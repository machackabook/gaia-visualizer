/**
 * Living chat-kernel contract — Stage 221.
 ...
 * Stage 221: session paste reconfirmed 2026-09-20 19:13 CDT. matchSessionPaste scans case labels.
 * Klein / hopf / figure8 / trefoil still not in the session switch.
 * GPU/TF auto path remains count > 1024.
 */

export const STAGE = 221;
...
export function confirmSessionKernel() {
  return {
    ...
    note: 'Session paste 2026-09-20 19:13 CDT matches beec41f1. Klein/hopf/figure8/trefoil stay runtime-only. Stage 221 GPU/TF auto-enable at count>1024; CPU evaluate zeros non-finite coords; GPU ids 12/13/8/7 unchanged.',
  };
}
