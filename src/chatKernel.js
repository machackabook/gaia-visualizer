/**
 * Living chat-kernel contract — Stage 96.
 ...
 * Stage 96: session paste reconfirmed 2026-09-13 13:11 CDT. matchSessionPaste scans case labels.
 * Klein / hopf / figure8 / trefoil still not in the session switch.
 */

export const STAGE = 96;
...
export function confirmSessionKernel() {
  return {
    ...
    note: 'Session paste 2026-09-13 13:11 CDT matches beec41f1. Klein/hopf/figure8/trefoil stay runtime-only. Stage 96 CPU evaluate matches GPU ids 12/13/8/7.',
  };
}
