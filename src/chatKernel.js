/**
 * Living chat-kernel contract — Stage 125.
 ...
 * Stage 125: session paste reconfirmed 2026-09-15 09:14 CDT. matchSessionPaste scans case labels.
 * Klein / hopf / figure8 / trefoil still not in the session switch.
 */

export const STAGE = 125;
...
export function confirmSessionKernel() {
  return {
    ...
    note: 'Session paste 2026-09-15 09:14 CDT matches beec41f1. Klein/hopf/figure8/trefoil stay runtime-only. Stage 125 CPU evaluate matches GPU ids 12/13/8/7.',
  };
}
