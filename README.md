...
See `STAGES.md`, `src/chatKernel.js`, `src/kernelSnapshot.js`, `src/kernelMac.js`, `src/fidelity.js`, `src/geometry.js`, `src/Node.js`, `src/evaluateKernel.glsl.js`, `src/gpuBuffer.js`, `src/transformFeedback.js`, `src/zeroCopy.js`.
